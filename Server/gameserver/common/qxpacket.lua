...
function qxpacket:setIp(value)
	self._ip = value;
end
function qxpacket:ip()
	return self._ip;
end
function qxpacket:setPort(value)
	self._port = value;
end
function qxpacket:port()
	return self._port;
end
function qxpacket:setSession(value)
	self._session = value;
end
function qxpacket:session()
